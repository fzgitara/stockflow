...
public class AuthController {
    ...
    /**
     * Stateless JWT: logout is performed by the client discarding the token.
     * The endpoint exists so the contract is explicit and future revocation
     * strategies (denylist) have a home.
     */
    @PostMapping("/logout")
